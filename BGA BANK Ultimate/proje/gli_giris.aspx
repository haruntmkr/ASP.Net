<%@ Page Title="" Language="C#" MasterPageFile="~/Gli_BireyselMasterPage.master" AutoEventWireup="true" CodeFile="gli_giris.aspx.cs" Inherits="gli_giris" ValidateRequest="False" %>
        ...
        <div class="span4">
         ...
         <!--Kutu başlangıç-->
                                 <div class="span5" >       <!--span 5 tag başlangıcı-->               
                                             ...
                                             <div class="span2">
                                                 <asp:HyperLink ID="HyperLink6" NavigateUrl="~/gli_paratrans.aspx" Font-Underline="false" runat="server">
                                             ...
                                             <div class="span2">
				                                 <asp:HyperLink ID="HyperLink5" NavigateUrl="~/gli_ayar_ip.aspx" Font-Underline="false"  runat="server">
                                             ...
                                             <div class="span2">
                                                 <a  href="gli_ozet.aspx?id=<%= _id %>" style="text-decoration:none;">
                                             ...
                                             <div class="span2">
                                                 <asp:HyperLink ID="HyperLink3" NavigateUrl="~/gli_atmbul.aspx" Font-Underline="false" runat="server">
                                             ...
                                             <div class="span2">
                                                 <asp:HyperLink ID="HyperLink2" NavigateUrl="gli_TLyukle.aspx" Font-Underline="false" runat="server">
                                             ...
                                             <div class="span2">
                                                  ...
                                                  <asp:HyperLink ID="HyperLink1" NavigateUrl="~/gli_ayar.aspx" Font-Underline="false" runat="server">
				                                        <div class="well well-small">
                                                                <h4 style="margin:-9px -9px -10px">

<%@ Page Title="Giriş Sayfası" Language="C#" MasterPageFile="~/Gli_IndexMasterPage.master" ValidateRequest="False" AutoEventWireup="true" CodeFile="gli_log_in.aspx.cs" Inherits="gli_log_in" %>
...
function OpenPopup() {
    ...
    popup("gli_sifremi_unuttum.aspx");
    ...
    <div class="col-md-6 col-md-offset-3 " style="text-align:center">
        <div class="" style="text-align:center">
            <div class="panel-heading">
               ...
               <form action="gli_log_in.aspx" class="form-inline" method="get" runat="server">
                  <br />

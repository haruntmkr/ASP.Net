<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/Gli_IndexMasterPage.master" AutoEventWireup="true" CodeFile="gli_index.aspx.cs" Inherits="gli_index" %>
...
<br />BGA BANK Ultimate, BGA Bilgi Güvenliği firmasıyla üniversite sanayi iş birliği kapsamında yapılmış bir projedir. 
<br /><b>TÜBİTAK 2209/B - Sanayi Odaklı Lisans Bitirme Tezi Destekleme Programı ile desteklenmiştir.</b> <br />
BGA BANK Ultimate üç aşamalı güvenlik katmanına sahiptir. İlk aşamada kullanıcılar sistemi güvenlik önlemi olmadan analiz edebilecektir. İkinci aşamada sunucu ile kullanıcıların arasındaki trafiği denetleyen bir web uygulaması güvenlik duvarı olan modsecurity bulunmaktadır. Üçüncü aşamada ise birinci aşamada sistemde bırakılan açıklar kapatılarak oluşturulmuş güvenli bir çevrim içi bankacılık uygulaması sunulmaktadır.
                                        <form action="gli_index.aspx" method="get" runat="server">
                    ...
                    <br />
                     <div class="row"><%--1.3. ana Satır başlangıcı--%>
                         ...
                         <asp:Label CssClass="pull-left" runat="server"></asp:Label>
                            <div class="span2">
				                                 <asp:HyperLink ID="HyperLink5" NavigateUrl="gli_paratrans.aspx" Font-Underline="false" runat="server">
                             ...
                             <div class="span2">
				                                 <asp:HyperLink ID="HyperLink1" NavigateUrl="gli_ayar_ip.aspx" Font-Underline="false" runat="server">
                           ...
                           <div class="span2">
				                                 <asp:HyperLink ID="HyperLink2" NavigateUrl="gli_atmbul.aspx" Font-Underline="false" runat="server">
                           ...
                           <div class="span2">
				                                 <asp:HyperLink ID="HyperLink3" NavigateUrl="gli_TLyukle.aspx" Font-Underline="false" runat="server">

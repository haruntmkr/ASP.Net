<%@ Page Title="" Language="C#" MasterPageFile="~/Gli_Menu.master" AutoEventWireup="true" CodeFile="gli_paratrans.aspx.cs" Inherits="gli_paratrans" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row" >
        ...
        <div class="span7" style="text-align:center" >
            <div class="well well-small" style="margin-top:initial" >
                <h4>Havale Yap</h4>
                 <form action="gli_paratrans.aspx" method="get" runat="server">

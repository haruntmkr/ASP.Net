<%@ Page Title="" Language="C#" MasterPageFile="~/Gli_BireyselMasterPage.master" ValidateRequest="true" AutoEventWireup="true" CodeFile="gli_gonderi.aspx.cs" Inherits="gli_gonderi" %>
   ...
   <div class="row">
       <div class="span6">
           <div class="well well-small">
                <form id="form1" method="post" action="gli_gonderi.aspx" runat="server">

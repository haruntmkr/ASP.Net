<%@ Page Title="" Language="C#" MasterPageFile="~/Gli_IndexMasterPage.master" AutoEventWireup="true" CodeFile="gli_iletisim.aspx.cs" Inherits="gli_iletisim" %>
                         ...
                         <h5 style="color:darkorange;text-align:center"><i class="icon-file"></i>İLETİŞİM FORMU</h5><hr />
                          <div class="row">              
                               <div class="span6 offset1" style="align-items:center">
                                     <form id="iletisim_form" name="iletisim_form" action="gli_iletisim.aspx" method="post" class="form-inline" runat="server" >
                                     <fieldset>
                                        <div class="row">
